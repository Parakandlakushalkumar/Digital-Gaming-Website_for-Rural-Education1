...
export const StudentOverview = ({ students, currentLanguage }: StudentOverviewProps) => {
  ...
  const getAverageScore = (student: StudentRecord) => getCurrentScore(student);
      ...
      <CardContent>
        <div className="grid gap-4">
          {students.map((student) => {
            ...
            return (
              <div key={getStudentId(student) || student.username} className="flex items-center gap-4 p-4 rounded-lg border bg-card/50">
