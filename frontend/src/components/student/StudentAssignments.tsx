...
export const StudentAssignments = ({ studentId, currentLanguage }: StudentAssignmentsProps) => {
  ...
  const handleSubmitAssignment = async () => {
    ...
    try {
      ...
      const submissionResponse = await assignmentAPI.createSubmission({
      ...
      if (!submissionResponse.success) throw new Error(submissionResponse.message || 'Submission failed');
